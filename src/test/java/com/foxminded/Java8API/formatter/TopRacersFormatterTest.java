...
public class TopRacersFormatterTest {
    ...
    static void setup() {
        ...
        RACERS_TEST_LIST.add(new Racer("Sebastian Vettel",
                "FERRARI", SEBASTIAN_VETTEL_TIME));
        RACERS_TEST_LIST.add(new Racer("Daniel Ricciardo",
                "RED BULL RACING TAG HEUER", DANIEL_RICCIARDO_TIME));
        RACERS_TEST_LIST.add(new Racer("Valtteri Bottas",
                "MERCEDES", VALTTERI_BOTTAS_TIME));
        RACERS_TEST_LIST.add(new Racer("Lewis Hamilton",
                "MERCEDES", LEWIS_HAMILTON_TIME));
        RACERS_TEST_LIST.add(new Racer("Stoffel Vandoorne",
                "MCLAREN RENAULT", STOFFEL_VANDOORNE_TIME));
        RACERS_TEST_LIST.add(new Racer("Kimi Raikkonen",
                "FERRARI", KIMI_RAIKKONEN_TIME));
        RACERS_TEST_LIST.add(new Racer("Fernando Alonso",
                "MCLAREN RENAULT", FERNANDO_ALONSO_TIME));
        RACERS_TEST_LIST.add(new Racer("Sergey Sirotkin",
                "WILLIAMS MERCEDES", SERGEY_SIROTKIN_TIME));
        RACERS_TEST_LIST.add(new Racer("Charles Leclerc",
                "SAUBER FERRARI", CHARLES_LECLERC_TIME));
        RACERS_TEST_LIST.add(new Racer("Sergio Perez",
                "FORCE INDIA MERCEDES", SERGIO_PEREZ_TIME));
        RACERS_TEST_LIST.add(new Racer("Romain Grosjean",
                "HAAS FERRARI", ROMAIN_GROSJEAN_TIME));
        RACERS_TEST_LIST.add(new Racer("Pierre Gasly",
                "SCUDERIA TORO ROSSO HONDA", PIERRE_GASLY_TIME));
        RACERS_TEST_LIST.add(new Racer("Carlos Sainz",
                "RENAULT", CARLOS_SAINZ_TIME));
        RACERS_TEST_LIST.add(new Racer("Esteban Ocon",
                "FORCE INDIA MERCEDES", ESTEBAN_OCON_TIME));
        RACERS_TEST_LIST.add(new Racer("Nico Hulkenberg",
                "RENAULT", NICO_HULKENBERG_TIME));
        RACERS_TEST_LIST.add(new Racer("Brendon Hartley",
